...
public class CommandTable{
    ...
    public CommandTable(){
        ...
        addCommand("read", "read <filePath>",
                "Read an HTML file from the specified file path. The file must exist.");
        addCommand("save", "save <filePath>",
                "Save the current HTML document to the specified file path. The file will be created if it doesn't exist.");
